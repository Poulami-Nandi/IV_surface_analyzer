...
if st.sidebar.button("Fetch and Analyze"):
    ...
    # Plot: Heatmap for selected expiration
    ...
    pivot = exp_filtered.pivot_table(index='strike', columns='expirationDate', values='impliedVolatility')
    fig2, ax2 = plt.subplots(figsize=(8, 6))
    sns.heatmap(pivot, annot=True, fmt=".2f", cmap='YlGnBu', ax=ax2)
    ...
    # Boxplot: IV distribution by expiration
